...
//       timeout,
//                          delta) {}
//   std::vector<std::chrono::nanoseconds> benchmark(Run run) {
...
//       std::vector<char> *output_host_ptr =
//       &(_mem_manager._output_host_buffer);
...
//         assertBuffersNotEqual(*output_host_ptr,
...
// private:
//   std::chrono::nanoseconds executeRun(Run run, unsigned int trial) {
